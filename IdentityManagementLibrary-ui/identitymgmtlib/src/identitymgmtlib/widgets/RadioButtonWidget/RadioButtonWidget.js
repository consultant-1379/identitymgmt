define([
    ...
    return core.Widget.extend({
        ...
        onViewReady: function() {
            _(this).inputElements = this.view.getElement().findAll('.eaIdentitymgmtlib-wRadioButtonWidget-input');
        ...
        getValue: function() {
            ...
            _(this).inputElements.forEach(function(input) {
                if (input.getProperty('checked')) {
                    result = (input.getAttribute('value') === 'true');
                }
            });
            return result;
        },
        ...
        addOnClick: function(value, method) {
            this.view.getElement().find('[value="' + value+'"]').setAttribute('onclick', method);
        },
