define(function() {
    ...
    return [{
        ...
        "type": "application",
        "name": "PKI_EE_Operator",
        "description": "Authorized to perform read operations on profiles and entities and entity certificates and CRLs and also download CRLs",
        "status": "ENABLED"
    }, {
        "type": "application",
        "name": "PKI_EE_Administrator",
        "description": "Authorized to perform CRUD operations on Entities, read operations on Profiles, algorithms, entity certificates and CRLs. Also permits to issue(generate), reissue, revoke, publish, unpublish Entity certificates",
        "status": "ENABLED"
    }, {
        "type": "application",
        "name": "PKI_Operator",
        "description": "Authorized to perform read profiles. Permits to perform operations on Configuration Management, Entity Management and Certificate Management",
        "status": "ENABLED"
    }, {
        "type": "application",
        "name": "PKI_Administrator",
        "description": "Authorized to perform operations on Profile Management, Configuration Management, Entity Management and Certificate Management",
        "status": "ENABLED"
    }, {
        "type": "application",
        ...
        "description": "Authorized for all actions in Target Group Manager",
        "status": "ENABLED"
    }, {
        "type": "application",
