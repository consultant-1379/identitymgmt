define([
    ...
    describe('Usersgroupedit - GROUP EDIT', function() {
        ...
        describe('UserGroupEdit - edit AUTHENTICATIONMODE', function(){
            ...
            it('Check step summary validation if AUTHENTICATIONMODE of 0 users was updated', function(done) {
                ...
                new Flow()
                    .setSteps([
                        ...
                        UserGroupEditSteps.clickModifyAuthModeCheckbox(),
                        UserGroupEditSteps.checkAuthModeStatus('enabled'),
                        UserGroupEditSteps.checkPwdAgeingStatus('disabled'),
